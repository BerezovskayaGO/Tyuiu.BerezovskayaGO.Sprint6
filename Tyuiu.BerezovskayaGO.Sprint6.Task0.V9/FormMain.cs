using Tyuiu.BerezovskayaGO.Sprint6.Task0.V9.Lib;
namespace Tyuiu.BerezovskayaGO.Sprint6.Task0.V9
{
    public partial class FormMain : Form
    {
        public FormMain()
        {
            ...
            {
                MessageBox.Show("Таск выполнил студент группы АСОиУб-24-1 Соснин Фёдор Михайлович", "Cообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
