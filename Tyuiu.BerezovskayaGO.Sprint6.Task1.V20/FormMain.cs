using Tyuiu.BerezovskayaGO.Sprint6.Task1.V20.Lib;
namespace Tyuiu.BerezovskayaGO.Sprint6.Task1.V20
{
    public partial class FormMain : Form
    {
        ...
        private void bettonDone_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Введены неверные данные", "Ошибкаа", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void buttonHelp_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Таск 1 выполнила студентка группы АСОиУб-24-1 Березовская Галина Олеговна", "Сообщение");
        }
    }
}
